...
// My technical skills across the MERN stack and related technologies
const skills = [
  'React.js',
  'Next.js',
  'Node.js',
...
// Fun stats about my development journey
const stats = [
...
/**
 * Counter component that animates numbers when visible
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && !hasAnimated) {
          ...
          // Animate count from 0 to target over 2 seconds
          const duration = 2000
          const steps = 60
...
export function AboutSection() {
  ...
  useEffect(() => {
    // Observe section and animate skills when in view
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          // Stagger skill reveals for visual appeal
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              B.Tech Computer Science student at Raj Kumar Goel Institute of Technology and Management,
              Ghaziabad. Passionate about building modern, responsive, and scalable web applications with
              clean UI and smooth user experiences. Currently diving deep into full-stack MERN development
              and TypeScript, and open to frontend developer roles, internships, and web development
              opportunities.
            </p>
